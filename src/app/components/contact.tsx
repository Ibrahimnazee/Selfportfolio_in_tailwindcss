        ...
        <div className="flex flex-col items-center md:w-1/2">
          ...
          <div className="flex flex-col items-center space-y-6">
            <div className="bg-white border border-gray-200 p-4 rounded-lg text-center w-72" data-aos="fade-up" data-aos-delay="300">
              ...
              <a href="mailto:ibrahimnazeer410@gmail.com" target="_blank" rel="noreferrer" className="text-blue-600 inline-flex items-center gap-1 mt-2">
                Write me
            ...
            <div className="bg-white border border-gray-200 p-4 rounded-lg text-center w-72" data-aos="fade-up" data-aos-delay="500">
              ...
              <span className="block text-sm">+923128765615</span>
              <a href="https://api.whatsapp.com/send?phone=03128765615" target="_blank" rel="noreferrer" className="text-blue-600 inline-flex items-center gap-1 mt-2">
                Write me
                <i className="uil uil-arrow-right"></i>
              </a>
            </div>
            ...
            <div className="bg-white border border-gray-200 p-4 rounded-lg text-center w-72" data-aos="fade-up" data-aos-delay="700">
              ...
              <span className="block text-sm break-words">Ibrahim-Nazeer</span>
              <a href="https://www.linkedin.com/in/ibrahim-nazeer-969514292/" target="_blank" rel="noreferrer" className="text-blue-600 inline-flex items-center gap-1 mt-2">
                View Me
                <i className="uil uil-arrow-right"></i>
              </a>
            </div>
